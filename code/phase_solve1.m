function [solve_phase44_main ,cycle] = phase_solve1(captured_images, phase_shift_steps)
...
cycle = round( (4 .* phase_vase_f4_unwrap - solve_phase33_main) ./ (2 * pi) );
...
cycle = round( (3 .* phase_vase_f16_unwrap - solve_phase44_main) ./ (2 * pi) );